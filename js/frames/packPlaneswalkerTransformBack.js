...
var masks = [{src:'/img/frames/planeswalker/transform/pinlineBack.svg', name:'Pinline'}, {src:'/img/frames/planeswalker/transform/titleBack.svg', name:'Title'}, {src:'/img/frames/planeswalker/regular/planeswalkerMaskType.png', name:'Type'}, {src:'/img/frames/planeswalker/transform/frameBack.svg', name:'Frame'}, {src:'/img/frames/planeswalker/transform/borderBack.svg', name:'Border'}];
...
availableFrames = [
	...
	{name:'Artifact Frame (Back)', src:'/img/frames/planeswalker/transform/ab.png', masks:masks},
